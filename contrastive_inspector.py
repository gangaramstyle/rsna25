...
@app.cell
def _(DataLoader, PrismOrderingDataset, SaimeseEncoder, torch):
    ...
    model.load_state_dict(torch.load("/gpfs/fs001/cbica/home/gangarav/rsna25/trained_models/log_1754934978.csv_s_2500.pth", map_location='cpu'))
    model.eval()

    data_iterator = iter(dataloader)
    return data_iterator, model
...
def _(
    ...
    x1 = model.branch(patches_1, idx_1)
    x2 = model.branch(patches_2, idx_2)
