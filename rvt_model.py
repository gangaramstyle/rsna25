    ...
    class Attention(nn.Module):
        ...
        def forward(self, x, pos_emb):
            ...
            if self.use_rotary:
                ...
                # TODO: Add an additional CLS token + Register tokens (code right now only uses 1 CLS)
                ...
                # TODO: concat back the CLS tokens (add +1 CLS and +N register)
...
class Transformer(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout = 0., use_rotary = True, use_glu = True):
        ...
        # TODO: Are we ok with max_freq of 10? What does this correspond to in cm?
        self.pos_emb = CoordinateRotaryEmbedding3D(dim_head, max_freq = 10)
...
@app.class_definition
class RvT(nn.Module):
    def __init__(self, *, patch_size, dim, depth, heads, mlp_dim, dropout = 0., emb_dropout = 0., use_rotary = True, use_glu = True):
        super().__init__()
